...
return [
    ...
    'detail' => 'ここには、文字列（string型※500文字以内）で入力して下さい',
    'data_type_match' => 'ここの:attributeにはデータ型:typeで入力して下さい（※登録画面では、カテゴリを選択しないとエラーになります）。',
    ...
    'integer' => 'ここの:attributeは整数値が値として入力されるようにしてください。　　　　　　　　　　　　　　　　　　　　　　　　　　　　　（※なお、商品登録画面では、プルダウンリストの中からいずれかを選択してください。）',
    ...
    'max' => [
        ...
        'string' => 'ここの欄（:attribute）は、:max文字（以内）で入力してください。',
    ...
    'name' => 'ここには、文字列（string型※100文字以内）で入力して下さい',
