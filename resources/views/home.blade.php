...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- publicフォルダ内のcssフォルダのhome.style.cssを参照 --}}
        ...
        {{-- home.blade.php独自のJavascript --}}
        <script src="{{ asset('js/home.js') }}"></script>
        {{-- tailwiindなんちゃらの長いやつ  ※消さない --}}
        <style>
                ...
                <div class="start-menu" style="margin-top: 2rem;">
                    <div class="dashboard-menu">
                        <a href="{{ route('dashboard') }}" >
                            {{'Dashboard'}}
                            <br>{{ '（※ログインセッションが切れていない場合、下がYou are not logged in yetになります）' }}
                        </a>
                    </div>
                    {{-- route()はroutesフォルダのweb.phpのnameの引数を入れることで、
                        パスの代わりになってくれるやつ --}}
                    {{-- @authはログイン状態にあるときに中身が表示されるようになるifみたいなやつ --}}
