...
//home SCD_map（SCD_mapある程度でき次第削除）
function showAlert() {
    window.alert('現在、作成途中です。しばらくお待ちください。');
}

//-----------Administrator Onlyのパスワード認証モーダル---------------------------------------------------
// リンクがクリックされたときの処理
function Modalshow1() {
...
function passwordCheck1() {
    ...
    if (password === "Miem605750887ToAdmin") {//左の""には照合させたいパスワードを入れる
        window.location.href = "../administrator";//左""内は本来のリンク先URL
    } else {
